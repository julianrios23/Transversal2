...
public class ViewEscritorio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Sistema Administracion Alumnos ULP");
        setUndecorated(true);

        jButton1.setBackground(new java.awt.Color(102, 0, 0));
        jButton1.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/transversal2/sources/icons8-macos-close-32.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/transversal2/sources/escritorio.jpeg"))); // NOI18N

        jMenu1.setText("Gestión");
        jMenu1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N

        jMenuItem1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jMenuItem1.setText("Gestión Alumno");
        ...
        jMenuItem2.setText("Gestión Materia");
        ...
        jMenuItem3.setText("Gestión Inscripción");
        ...
        jMenuItem4.setText("Gestión Notas");
        ...
        jMenuItem5.setText("Listar Por Materia");
        ...
        jMenuItem6.setText("Listar Alumnos");
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        ViewListarAlumnos va = new ViewListarAlumnos();
        va.setVisible(true);
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        ViewAlumnoxMateria apm = new ViewAlumnoxMateria();
        apm.setVisible(true);
